...
export const PWAInstallBanner: React.FC = () => {
  ...
  const handleInstallClick = async () => {
    if (!deferredPrompt) {
      alert('Para instalar en iOS: Pulsa el botón Compartir de Safari y selecciona "Añadir a pantalla de inicio". En Android: Menú de Chrome > "Instalar aplicación".')
      return
    }
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 hidden sm:block">
              Accede rápido como app nativa, con seguimiento offline y alertas en tiempo real.
            </p>
          </div>
        </div>
