export type SportType = 'football' | 'basketball' | 'tennis' | 'baseball' | 'esports' | 'mma'

export type BetStatus = 'PENDING' | 'LIVE' | 'WON' | 'LOST' | 'CASHOUT' | 'VOID'

export type ConditionStatus = 'PENDING' | 'IN_PROGRESS' | 'MET' | 'BUSTED' | 'CLUTCH_DANGER'
